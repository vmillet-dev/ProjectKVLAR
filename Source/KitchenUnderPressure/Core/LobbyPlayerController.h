...
/**
 * Player controller for the waiting room. Builds the lobby UI on the local client and
 * relays ready/start requests to the server, plus leaving back to the main menu.
 */
UCLASS()
