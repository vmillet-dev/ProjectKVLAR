...
choco install -y visualstudio2022buildtools --package-parameters "--quiet --wait --norestart --nocache --installPath C:\BuildTools --add Microsoft.VisualStudio.Workload.VCTools --add Microsoft.VisualStudio.Workload.MSBuildTools --add Microsoft.VisualStudio.Component.NuGet --add Microsoft.VisualStudio.Component.VC.Tools.x86.x64 --add Microsoft.VisualStudio.Component.Windows10SDK.$windows_sdk_version --add Microsoft.Net.Component.4.5.TargetingPack --add Microsoft.Net.Component.4.6.2.TargetingPack --add Microsoft.Net.ComponentGroup.DevelopmentPrerequisites --add Microsoft.NetCore.Component.SDK --add Microsoft.NetCore.Component.Runtime.3.1"
